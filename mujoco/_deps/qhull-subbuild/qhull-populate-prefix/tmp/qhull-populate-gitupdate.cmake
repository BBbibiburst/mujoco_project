...
execute_process(
  COMMAND "/usr/bin/git" show-ref "62ccc56af071eaa478bef6ed41fd7a55d3bb2d80"
  WORKING_DIRECTORY "/home/zmy/MyProject/mujoco/build/_deps/qhull-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "62ccc56af071eaa478bef6ed41fd7a55d3bb2d80")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("62ccc56af071eaa478bef6ed41fd7a55d3bb2d80" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/62ccc56af071eaa478bef6ed41fd7a55d3bb2d80")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/zmy/MyProject/mujoco/build/_deps/qhull-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/zmy/MyProject/mujoco/build/_deps/qhull-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
