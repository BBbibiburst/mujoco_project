...
用法：
    python -m source.rl.eval_ppo --task pick_place --model rl_models/pick_place/.../ppo_pick_place_final.zip
    python -m source.rl.eval_ppo --task insert     --model rl_models/insert/.../best_model/best_model.zip
    python -m source.rl.eval_ppo --task push       --model path/to/model.zip --episodes 20 --no-render
...
from source.rl.train_ppo import TASK_REGISTRY, make_env
from source.env.demo import render_tactile_heatmap, _format_info_line
